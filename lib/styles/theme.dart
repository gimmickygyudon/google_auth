  ...
  static InputDecoration inputDecorationForm({
    ...
    return InputDecoration(
      ...
      suffixIcon: visibility_ != null 
        ? visibility_ ? const Icon(Icons.visibility_outlined) : const Icon(Icons.visibility_off_outlined)
        : null,
      errorMaxLines: 3,
      ...
      enabledBorder: condition ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Theme.of(context).colorScheme.primary.withOpacity(0.5), width: 1)) : null,
      focusedBorder: condition ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Theme.of(context).colorScheme.primary, width: 2)) : null,
      border: condition ? OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Theme.of(context).colorScheme.primary, width: 2)) : null
    );
  }
}
