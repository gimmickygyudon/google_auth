...
class _RegisterRouteState extends State<RegisterRoute> {
  ...
  void registerUser() {
    ...
    SQL.retrieve(query: 'user_email', value: _emailController.text, api: 'ousr').then((value) {
      if (value.isEmpty) {
        SQL.retrieve(query: 'phone_number', value: _phonenumberController.text, api: 'ousr').then((value) {
          if (value.isNotEmpty) {
