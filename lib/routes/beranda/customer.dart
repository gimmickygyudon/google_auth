                              ...
                              return TextField(
                                ...
                                decoration: Styles.inputDecorationForm(
                                  ...
                                  icon: Padding(
                                    ...
                                    child: Icon(Icons.face, size: 22, color: Theme.of(context).colorScheme.secondary),
                                  ),
                                    ...
                                    trailing: Padding(
                                      ...
                                      child: Badge(
                                        ...
                                        ? Container(
                                          ...
                                          child: Icon(Icons.check, color: Theme.of(context).colorScheme.surface, size: 16, weight: 700, grade: 200)
                                        )
                                        : null,
                                        largeSize: 22,
                                        child: CircleAvatar(
