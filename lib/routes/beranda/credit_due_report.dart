...
class _CreditDueWidgetState extends State<CreditDueWidget> {
  ...
  Future<CreditDueReport> setCreditDueReport() async {
    ...
    if (id_ocst != null) {
      ...
      return CreditDueReport(total_balance: 'Rp0.0', total_balance_due: 'Rp0.0 Jt', percent_balance: 100, percent_balance_due: 0);
    }
  }
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(total_balance, style: Theme.of(context).textTheme.titleSmall),
                        const SizedBox(height: 2),
                        Row(
                          children: [
                            Icon(Icons.arrow_downward, size: 14, color: Theme.of(context).colorScheme.error, weight: 700, grade: 200),
